...
import "./ThePerfectMarriageChat.css";
...
const ThePerfectMarriageChat = () => {
  ...
  return (
    <div className="chat-container">
      <h1 className="chat-title">The Perfect Marriage - Chat Room</h1>
...
export default ThePerfectMarriageChat;
